...
function runBaseTests() {
  og_scatter_plot_1 = document.getElementById('og_scatter_plot_1');

  suite('Base Automation Tests for og-scatter-plot', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-scatter-plot fixture is created', function() {
      assert.isTrue(document.getElementById('og_scatter_plot_1') !== null);
    });
